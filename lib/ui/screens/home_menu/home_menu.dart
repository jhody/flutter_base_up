...
import 'package:yleon/ui/common/app_backdrop.dart';
import 'package:yleon/ui/common/app_icons.dart';
import 'package:yleon/ui/common/controls/app_header.dart';
import 'package:yleon/ui/common/controls/locale_switcher.dart';
import 'package:yleon/ui/common/pop_navigator_underlay.dart';
import 'package:yleon/ui/common/wonderous_logo.dart';
import 'package:yleon/ui/screens/home_menu/about_dialog_content.dart';
...
class _HomeMenuState extends State<HomeMenu> {
  ...
  void _handleAboutPressed(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      applicationLegalese: '© 2024 yhody',
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        /// Backdrop / Underlay / fondo oscuro translúcido
        AppBackdrop(
          strength: .5,
